...
import { Search, Info, ShieldAlert, CheckCircle, QrCode, MapPin, Clock, ShieldCheck, ChevronRight, X, MessageSquare, Leaf, Weight, TrendingDown, Zap, Loader2, Navigation } from 'lucide-react';
